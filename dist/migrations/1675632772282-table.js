...
exports.table1675632772282 = void 0;
class table1675632772282 {
    name = 'table1675632772282';
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "orders" ("order_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "count" integer DEFAULT '0', "custommerId" uuid, "productId" uuid, CONSTRAINT "REL_8624dad595ae567818ad9983b3" UNIQUE ("productId"), CONSTRAINT "PK_cad55b3cb25b38be94d2ce831db" PRIMARY KEY ("order_id"))`);
...
exports.table1675632772282 = table1675632772282;
