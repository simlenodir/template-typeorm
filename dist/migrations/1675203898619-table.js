...
exports.table1675203898619 = void 0;
class table1675203898619 {
    name = 'table1675203898619';
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "orders" ("order_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "custommerId" uuid, CONSTRAINT "PK_cad55b3cb25b38be94d2ce831db" PRIMARY KEY ("order_id"))`);
...
exports.table1675203898619 = table1675203898619;
